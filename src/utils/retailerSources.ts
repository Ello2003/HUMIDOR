...
export const UK_RETAILER_SOURCES: RetailerSource[] = [
  { retailer: 'C.Gars Ltd', baseUrl: 'https://www.cgarsltd.co.uk', country: 'GB', enabled: true, productUrlPatterns: [/-p-\d+\.html/i], sitemapUrl: 'https://www.cgarsltd.co.uk/sitemap.xml', discoveryPaths: ['/cigars/', '/cigars'], requestDelayMs: 1500, maxPagesPerScan: 20, parserType: 'generic-product', termsUrl: 'https://www.cgarsltd.co.uk/customer-service/terms.htm%26title%3DTerms%2Band%2BConditions', complianceStatus: 'review_required' },
