...
export const UK_RETAILER_SOURCES: RetailerSource[] = [
  { retailer: 'C.Gars Ltd', baseUrl: 'https://www.cgarsltd.co.uk', country: 'GB', enabled: true, productUrlPatterns: [/\/(?:product|cigar|padron|cigars?)\b/i], sitemapUrl: 'https://www.cgarsltd.co.uk/sitemap.xml', discoveryPaths: ['/cigars/', '/cigars'], requestDelayMs: 1500, maxPagesPerScan: 20, parserType: 'generic-product', termsUrl: 'https://www.cgarsltd.co.uk/customer-service/terms.htm%26title%3DTerms%2Band%2BConditions', complianceStatus: 'review_required' },
  ...
  { retailer: 'James J. Fox (London)', baseUrl: 'https://www.jjfox.co.uk', country: 'GB', enabled: true, productUrlPatterns: [/\/product/i], sitemapUrl: 'https://www.jjfox.co.uk/sitemap.xml', discoveryPaths: ['/cigars', '/products'], requestDelayMs: 1500, maxPagesPerScan: 20, parserType: 'generic-product', termsUrl: 'https://www.jjfox.co.uk/terms-conditions', complianceStatus: 'review_required' },
  ...
  { retailer: 'Turmeaus Tobacconist', baseUrl: 'https://www.turmeaus.co.uk', country: 'GB', enabled: true, productUrlPatterns: [/\/.*-p-\d+\.html$/i], sitemapUrl: 'https://www.turmeaus.co.uk/dynamic_sitemap.php', searchUrlTemplate: 'https://www.turmeaus.co.uk/advanced_search_result.php?keywords={query}', discoveryPaths: ['/cigars', '/all_products.php?display=all'], requestDelayMs: 1500, maxPagesPerScan: 20, parserType: 'generic-product', termsUrl: 'https://www.turmeaus.co.uk/customer-service/terms.htm', complianceStatus: 'review_required' },
  ...
  { retailer: 'The House of Cigars', baseUrl: 'https://www.thehouseofcigars.co.uk', country: 'GB', enabled: true, productUrlPatterns: [/\/product\//i], sitemapUrl: 'https://www.thehouseofcigars.co.uk/sitemap_index.xml', discoveryPaths: ['/shop/'], requestDelayMs: 1500, maxPagesPerScan: 20, parserType: 'generic-product', termsUrl: 'https://www.thehouseofcigars.co.uk/terms-conditions/', complianceStatus: 'review_required' },
