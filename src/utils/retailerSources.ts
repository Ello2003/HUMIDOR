...
export const UK_RETAILER_SOURCES: RetailerSource[] = [
  ...
  { retailer: 'Turmeaus Tobacconist', baseUrl: 'https://www.turmeaus.co.uk', country: 'GB', enabled: true, productUrlPatterns: [/\/.*-p-\d+\.html$/i], sitemapUrl: 'https://www.turmeaus.co.uk/sitemap.xml', discoveryPaths: ['/cigars'], requestDelayMs: 1500, maxPagesPerScan: 20, parserType: 'generic-product', termsUrl: 'https://www.turmeaus.co.uk/customer-service/terms.htm', complianceStatus: 'review_required' },
